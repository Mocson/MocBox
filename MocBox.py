...
cmds.text("ManipBox")
cmds.separator( h=10 )
cmds.button( label = 'Start', w=200, h=40, command='ManipBox()')

cmds.separator( h=10 )
cmds.text("KeyframeBox")
cmds.separator( h=10 )
cmds.button( label = 'Start', w=200, h=40, command='KeyframeBox()')

cmds.separator( h=10 )
cmds.text("TexReverse")
cmds.separator( h=10 )
cmds.button( label = 'Start', w=200, h=40, command='TexReverse()')
